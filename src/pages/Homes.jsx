...
import { FaArrowRight, FaLinkedin, FaYoutube, FaEnvelope, FaMapMarkerAlt, FaChevronRight } from "react-icons/fa";
...
const Home = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#14141B] text-[#14141B] dark:text-[#B8B7A4] min-h-screen selection:bg-[#D9FE42] selection:text-[#14141B] overflow-x-hidden font-sans">
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-5 sticky top-28">
              ...
              <div className="mt-8">
                <a href="https://www.forbes.lu/luxembourg-voltcore-heats-up-ev-innovation-across-europe/" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-3 px-5 py-3 rounded-full bg-[#14141B] dark:bg-[#D9FE42] text-white dark:text-[#14141B] text-xs font-bold uppercase tracking-wider transition-all hover:bg-[#D9FE42] hover:text-[#14141B] dark:hover:bg-white">
                  <span>Read On Forbes</span>
                  <FaChevronRight size={10} className="transition-transform group-hover:translate-x-1" />
                </a>
              </div>
            </div>
      ...
      <section className="w-full py-32 bg-white dark:bg-[#14141B] border-t border-[#14141B]/5 dark:border-[#B8B7A4]/5">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="space-y-6">
            {PLATFORMS.map((p) => (
              <div key={p.name} className="group relative border border-transparent bg-[#14141B] overflow-hidden rounded-3xl transition-all duration-500 hover:border-[#94C356]/40 shadow-xl">
      ...
      {/* ── 5. INDUSTRIES (OPACITÉ CORRIGÉE POUR UNE MEILLEURE VISIBILITÉ) ── */}
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            {INDUSTRIES.map((ind, i) => {
              ...
              return (
                <Link key={ind.slug} to={`/industries/${ind.slug}`} className={`${colSpan} group relative rounded-2xl overflow-hidden block border border-transparent bg-[#14141B] h-80 flex flex-col justify-end p-8 transition-all duration-500 hover:border-[#94C356]/30 shadow-lg`}>
                  {ind.image && (
                    /* L'opacité passe à 80% (au lieu de 30%) pour rendre l'image bien nette, et à 100% au survol */
                  ...
                  {/* Dégradé légèrement adouci pour laisser respirer le fond de l'image rehaussée */}
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <div className="divide-y divide-[#14141B]/10 dark:divide-[#B8B7A4]/10">
            {NEWS.map((n) => {
              ...
              return (
                <LinkComponent key={n.title} {...linkProps} className="group py-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 block transition-all duration-300">
      ...
      <section className="w-full py-32 bg-[#B8B7A4]/20 dark:bg-[#14141B] border-t border-[#14141B]/5 dark:border-[#B8B7A4]/5">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {TEAM_PREVIEW.map((m) => (
              <div key={m.name} className="group bg-white dark:bg-[#B8B7A4]/5 border border-[#14141B]/5 dark:border-[#B8B7A4]/10 rounded-2xl overflow-hidden transition-all duration-300 hover:border-[#94C356]/30">
      ...
      <footer className="w-full bg-[#B8B7A4]/20 dark:bg-[#0e0e13] text-[#14141B]/60 dark:text-[#B8B7A4]/70 py-20 border-t border-[#14141B]/10 dark:border-[#B8B7A4]/10 relative z-10 text-xs">
        <div className="container mx-auto px-6 max-w-6xl grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["ActiveFil™ Matrix","TargetHeat™ Systems","SensiTerm Fabric"].map((p) => ( // SensiTerm nettoyé ici aussi
