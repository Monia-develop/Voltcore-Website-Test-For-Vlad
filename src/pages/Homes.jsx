...
const TeamCard = ({ m }) => {
  ...
  return (
    <div onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}
      ...
      style={{ border: hovered ? "1px solid #D9FE42" : "1px solid #e8e6e0", borderColor: hovered ? "#D9FE42" : undefined, boxShadow: hovered ? "0 16px 40px rgba(217,254,66,0.14)" : "0 2px 8px rgba(0,0,0,0.04)", transform: hovered ? "translateY(-4px)" : "translateY(0)", transition: "all 0.4s cubic-bezier(0.34,1.56,0.64,1)" }}
    >
      <div className="h-48 flex items-center justify-center border-b border-[#e8e6e0] dark:border-[#2a2a3a] relative overflow-hidden transition-colors duration-300"
        style={{ background: hovered ? "#fbfde8" : "#f5f4f0" }}
      >
        {hovered && [1,2,3].map(i => (
          <div key={i} className="absolute rounded-full border border-[#D9FE42]/20 pointer-events-none"
        ...
        <span className="text-8xl font-black tracking-tighter transition-colors duration-300 relative z-10"
          style={{ color: hovered ? "rgba(217,254,66,0.35)" : "#e0deda" }}
        >{m.name[0]}</span>
      </div>
      <div className="p-5">
        <div className="text-sm font-bold text-[#14141B] dark:text-white">{m.name}</div>
        <div className="text-xs text-[#12503C] dark:text-[#D9FE42] font-medium tracking-wide mt-1">{m.role}</div>
      </div>
    </div>
  );
};
  ...
  return (
    <div className="bg-white dark:bg-[#14141B] text-[#14141B] dark:text-[#B8B7A4] min-h-screen overflow-x-hidden font-sans selection:bg-[#D9FE42] selection:text-[#14141B]">
      ...
      <section id="who-we-are" className="px-10 py-24 bg-white dark:bg-[#14141B]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#e8e6e0] dark:bg-[#2a2a3a] mt-16 rounded-2xl overflow-hidden border border-[#e8e6e0] dark:border-[#2a2a3a]">
          ...
          <Reveal delay={80} className="bg-white dark:bg-[#1a1a22] p-10 group">
            <div className="text-6xl font-black tracking-tighter text-[#D9FE42] mb-2 inline-block transition-transform duration-300 group-hover:scale-110"><CountUp end={6} duration={1000} /></div>
      ...
      <section id="industries" className="px-10 py-24 bg-white dark:bg-[#14141B]">
        ...
        <Reveal delay={300}>
          <Link to="/industries" className="group inline-flex items-center gap-2 mt-10 text-xs font-black uppercase tracking-widest text-[#12503C] dark:text-[#D9FE42] hover:text-[#14141B] dark:hover:text-white transition-colors">
